...
const lastNameMinLengthSchemaObj = getLengthSchemaObj(
    fieldStringName,
    NAME_MIN_LENGTH,
    true
);
const lastNameMaxLengthSchemaObj = getLengthSchemaObj(
    fieldStringName,
    NAME_MAX_LENGTH,
    false
);
...
export const unObjetoLastName = getSchemaObject(
    fieldStringName,
    minLengthObj_lastName,
    maxLengthObj_lastName
);
