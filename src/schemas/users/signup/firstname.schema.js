...
const firstNameMinLengthSchemaObj = getLengthSchemaObj(fieldStringName, NAME_MIN_LENGTH, true);
const firstNameMaxLengthSchemaObj = getLengthSchemaObj(fieldStringName, NAME_MAX_LENGTH, false);
...
export const unObjetoFirstName = getSchemaObject(fieldStringName, minLengthObj_firstName, maxLengthObj_firstName);
